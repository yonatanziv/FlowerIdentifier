...
const int Consts::SUCCESS											= 0;	//Success flag.
...
const int Consts::INNER_CONTUOR_MINIMUM_THRESHOLD					= 10;	//Minimum threshold to find inner contour. (Minimum color distance threshold used at the binarization process)
const int Consts::MAX_POINTS_FLAG									= 0;	//This flag is passed to localMinMaxPointsInner function if we want to find local max points.   
const int Consts::MIN_POINTS_FLAG									= 1;	//This flag is passed to localMinMaxPointsInner function if we want to find local min points.
const int Consts::GRUBCUT_ITERATIONS								= 9;	//Number of iterations of grabcut algorithm.
const int Consts::DEBUG												= 1;	//Debug mode indicator.
const string Consts::SVM_SERIALIZE_PATH								= "samples\\serialization\\svmSerialize.txt";
const string Consts::SAMPLES_DIR_PATH								= "samples";									
const string Consts::SVM_SERIALIZATION_DIR_PATH						= "serialization";
const string Consts::CENTERS_FILE_NAME								= "centers.txt";
const string Consts::SVM_SERIALIZE_FILE_NAME						= "svmSerialize.txt";
const string Consts::PREDICT_DIR_PATH								= "predict";
const string Consts::ALL_CENTERS_FILE_NAME							= "All_Centers.txt";
